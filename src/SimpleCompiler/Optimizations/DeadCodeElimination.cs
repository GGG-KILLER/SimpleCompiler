...
public sealed class DeadCodeElimination : IOptimizationPass
{
    ...
    public void Execute(IrGraph graph)
    {
        ...
        // Remove unneeded conditional branches and assignments
        DeadAssignmentAndBranchElimination(graph);
    ...
    private static void DeadAssignmentAndBranchElimination(IrGraph graph)
    {
