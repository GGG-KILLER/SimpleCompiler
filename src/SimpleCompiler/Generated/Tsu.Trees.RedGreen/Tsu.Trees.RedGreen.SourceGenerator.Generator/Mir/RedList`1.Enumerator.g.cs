...
namespace SimpleCompiler.MIR
{
    ...
    public readonly partial struct MirList<TNode>
    {
        /// <summary>
        /// The enumerator for <see cref="MirList{TNode}"/>.
        /// </summary>
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
        ...
        {
            private readonly MirList<TNode> _list;
            private int _index;

            internal Enumerator(MirList<TNode> list)
            {
                _list = list;
                _index = -1;
            }
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
            public static bool operator ==(MirList<TNode>.Enumerator left, MirList<TNode>.Enumerator right) =>
                throw new NotSupportedException();
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
        ...
        private class EnumeratorImpl : IEnumerator<TNode>
        {
            ...
            internal EnumeratorImpl(in MirList<TNode> list)
            {
