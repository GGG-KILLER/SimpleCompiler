...
{
    internal readonly partial struct IrList<TNode> : global::System.IEquatable<IrList<TNode>>
        where TNode : global::SimpleCompiler.IR.Internal.IrNode
    {
        private readonly global::SimpleCompiler.IR.Internal.IrNode? _node;

        internal IrList(global::SimpleCompiler.IR.Internal.IrNode? node)
        {
            _node = node;
        }

        internal global::SimpleCompiler.IR.Internal.IrNode? Node => _node;
        ...
        internal global::SimpleCompiler.IR.Internal.IrNode? ItemUntyped(int index)
        {
        ...
        internal void CopyTo(int offset, global::SimpleCompiler.IR.Internal.IrNode[] array, int arrayOffset, int count)
        {
            for (int i = 0; i < count; i++)
            {
        ...
        public override bool Equals(object? obj) => (obj is IrList<TNode> list) && Equals(list);

        public override int GetHashCode() => _node != null ? _node.GetHashCode() : 0;

        public static implicit operator IrList<TNode>(TNode node) => new(node);

        public static implicit operator IrList<TNode>(IrList<global::SimpleCompiler.IR.Internal.IrNode> nodes) => new(nodes._node);

        public static implicit operator IrList<global::SimpleCompiler.IR.Internal.IrNode>(IrList<TNode> nodes) => new(nodes.Node);
    }
}
