...
namespace SimpleCompiler.IR
{
    ...
    public readonly partial struct IrList<TNode>
    {
        /// <summary>
        /// The enumerator for <see cref="IrList{TNode}"/>.
        /// </summary>
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
            public static bool operator ==(IrList<TNode>.Enumerator left, IrList<TNode>.Enumerator right) =>
                throw new NotSupportedException();
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
        ...
        private class EnumeratorImpl : IEnumerator<TNode>
        {
            ...
            internal EnumeratorImpl(in IrList<TNode> list)
            {
