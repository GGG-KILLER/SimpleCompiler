...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class ArrayMethod : MethodInfo
    {
        ...
        public override ICustomAttributeProvider ReturnTypeCustomAttributes => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_SymbolMethod");

        public override object Invoke(object? obj, BindingFlags invokeAttr, Binder? binder, object?[]? parameters, CultureInfo? culture)
            => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_SymbolMethod");
