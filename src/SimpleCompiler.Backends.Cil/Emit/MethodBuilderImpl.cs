...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class MethodBuilderImpl : MethodBuilder
    {
            ...
            ModuleBuilderImpl module, TypeBuilderImpl declaringType)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_NoStaticVirtual");
            }
        ...
        internal void CreateDllImportData(string dllName, string entryName, CallingConvention nativeCallConv, CharSet nativeCharSet) => _dllImportData = DllImportData.Create(dllName, entryName, nativeCallConv, nativeCharSet);
        ...
        protected override GenericTypeParameterBuilder[] DefineGenericParametersCore(params string[] names)
        {
            if (_typeParameters != null)
                throw new InvalidOperationException("TODO: Fill in with result of SR.InvalidOperation_GenericParametersAlreadySet");
        ...
        protected override ParameterBuilder DefineParameterCore(int position, ParameterAttributes attributes, string? strParamName)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("TODO: Fill in with result of SR.ArgumentOutOfRange_ParamSequence");
            }
        ...
        protected override ILGenerator GetILGeneratorCore(int size)
        {
            ...
            {
                throw new InvalidOperationException("TODO: Fill in with result of SR.InvalidOperation_ShouldNotHaveMethodBody");
            }
        ...
        public override RuntimeMethodHandle MethodHandle => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");
        ...
        public override object[] GetCustomAttributes(bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");

        public override object[] GetCustomAttributes(Type attributeType, bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");
        ...
        public override object Invoke(object? obj, BindingFlags invokeAttr, Binder? binder, object?[]? parameters, CultureInfo? culture)
             => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");

        public override bool IsDefined(Type attributeType, bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");
