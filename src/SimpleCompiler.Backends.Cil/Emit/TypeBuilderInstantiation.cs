...
namespace SimpleCompiler.Backend.Cil.Emit
{
    ...
    internal sealed partial class TypeBuilderInstantiation : TypeInfo
    {
        ...
        protected override TypeAttributes GetAttributeFlagsImpl() => _genericType.Attributes;
        ...
        protected override bool IsValueTypeImpl() => _genericType.IsValueType;
        ...
        public override Type GetGenericTypeDefinition() => _genericType;

        [RequiresUnreferencedCode("If some of the generic arguments are annotated (either with DynamicallyAccessedMembersAttribute, or generic constraints), trimming can't validate that the requirements of those annotations are met.")]
        public override Type MakeGenericType(params Type[] inst) => throw new InvalidOperationException("TODO: Fill in with result of SR.Format(SR.Arg_NotGenericTypeDefinition, this)");
