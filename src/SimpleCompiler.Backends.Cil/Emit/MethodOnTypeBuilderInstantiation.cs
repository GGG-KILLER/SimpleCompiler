...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed partial class MethodOnTypeBuilderInstantiation : MethodInfo
    {
        ...
        internal static MethodInfo GetMethod(MethodInfo method, TypeBuilderInstantiation type) => new MethodOnTypeBuilderInstantiation(method, type);
        #endregion
        ...
        public override MethodInfo MakeGenericMethod(params Type[] typeArgs)
        {
            ...
            {
                throw new InvalidOperationException("TODO: Fill in with result of SR.Format(SR.Arg_NotGenericMethodDefinition, this)");
            }
