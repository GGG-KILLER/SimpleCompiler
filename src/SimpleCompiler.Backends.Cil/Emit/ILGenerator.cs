...
namespace SimpleCompiler.Backend.Cil.Emit
{
    public abstract class ILGenerator
    {
        ...
        public virtual void ThrowException([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] Type excType)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_NotExceptionType", nameof(excType));
            }
            ConstructorInfo? con = excType.GetConstructor(Type.EmptyTypes)
                ?? throw new ArgumentException("TODO: Fill in with result of SR.Arg_NoDefCTorWithoutTypeName", nameof(excType));
        ...
        public virtual void EmitWriteLine(LocalBuilder localBuilder)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.NotSupported_OutputStreamUsingTypeBuilder");
            }
            parameterTypes[0] = cls;
            MethodInfo? mi = typeof(TextWriter).GetMethod("WriteLine", parameterTypes)
                ?? throw new ArgumentException("TODO: Fill in with result of SR.Argument_EmitWriteLineType", nameof(localBuilder));
        ...
        public virtual void EmitWriteLine(FieldInfo fld)
        {
            ...
            {
                throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_OutputStreamUsingTypeBuilder");
            }
            parameterTypes[0] = cls;
            MethodInfo? mi = typeof(TextWriter).GetMethod("WriteLine", parameterTypes)
                ?? throw new ArgumentException("TODO: Fill in with result of SR.Argument_EmitWriteLineType", nameof(fld));
            Emit(OpCodes.Callvirt, mi);
        }
