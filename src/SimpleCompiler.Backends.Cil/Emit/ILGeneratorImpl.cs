...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class ILGeneratorImpl : ILGenerator
    {
        ...
        public override void BeginCatchBlock(Type? exceptionType)
        {
            ...
            {
                throw new NotSupportedException("TODO: Fill in with result of SR.Argument_NotInExceptionBlock");
            }
            ...
            if (currentExBlock.State == ExceptionState.Filter)
            {
                ...
                {
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_ShouldNotSpecifyExceptionType");
                }
        ...
        public override void Emit(OpCode opcode, ConstructorInfo con)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_NotMethodCallOpcode", nameof(opcode));
            }
        ...
        public override void Emit(OpCode opcode, Label label)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_InvalidLabel");
            }
        }
        ...
        public override void Emit(OpCode opcode, Label[] labels)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_MustBeSwitchOpCode", nameof(opcode));
            }
        ...
        public override void Emit(OpCode opcode, LocalBuilder local)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_UnmatchedMethodForLocal", nameof(local));
            }
            ...
            Type? returnType, Type[]? parameterTypes, Type[]? optionalParameterTypes)
        {
            if (optionalParameterTypes != null && optionalParameterTypes.Length > 0)
            {
                if ((callingConvention & CallingConventions.VarArgs) == 0)
                {
                    ...
                    throw new InvalidOperationException("TODO: Fill in with result of SR.InvalidOperation_NotAVarArgCallingConvention");
                }
            }
        ...
        public override void EndExceptionBlock()
        {
            ...
            {
                throw new InvalidOperationException("TODO: Fill in with result of SR.Argument_BadExceptionCodeGen");
            }
        ...
        public override void MarkLabel(Label loc)
        {
            if (_labelTable.TryGetValue(loc, out LabelInfo? labelInfo))
            {
                ...
                {
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_RedefinedLabel");
                }
