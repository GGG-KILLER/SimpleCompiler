...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class DllImportData
    {
        ...
        internal static DllImportData Create(CustomAttributeInfo attr, out bool preserveSig)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_DllNameCannotBeEmpty");
            }
        ...
        internal static MarshallingData CreateMarshallingData(ConstructorInfo con, ReadOnlySpan<byte> binaryAttribute, bool isField)
        {
            ...
            switch (unmanagedType)
            {
                ...
                case UnmanagedType.ByValArray:
                    if (!isField)
                    {
                        throw new NotSupportedException("TODO: Fill in with result of SR.Format(SR.NotSupported_UnmanagedTypeOnlyForFields, nameof(UnmanagedType.ByValArray))");
                    }
...
#pragma warning restore CS0618
                ...
                default:
                    ...
                    {
                        throw new ArgumentException("TODO: Fill in with result of SR.Argument_InvalidArgumentForAttribute", nameof(con));
                    }
                    else
                    {
                        // named parameters ignored with no error
        ...
        private static void DecodeMarshalAsFixedString(string[] paramNames, object?[] values, MarshallingData info)
        {
            ...
            for (int i = 0; i < paramNames.Length; i++)
            {
                switch (paramNames[i])
                {
                    ...
                    case "ArraySubType":
                    case "SizeParamIndex":
                        throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_InvalidParameterForUnmanagedType, paramNames[i], \"ByValTStr\")", "binaryAttribute");
            ...
            if (elementCount < 0)
            {
                ...
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_SizeConstMustBeSpecified", "binaryAttribute");
            }
        ...
        private static void DecodeMarshalAsSafeArray(string[] paramNames, object?[] values, MarshallingData info)
        {
            ...
            for (int i = 0; i < paramNames.Length; i++)
            {
                switch (paramNames[i])
                {
                    ...
                    case "SizeConst":
                    case "SizeParamIndex":
                        throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_InvalidParameterForUnmanagedType, paramNames[i], \"SafeArray\")", "binaryAttribute");
                        // other parameters ignored with no error
                }
            }
            ...
            switch (elementTypeVariant)
            {
                ...
                default:
                    ...
                    {
                        throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_InvalidParameterForUnmanagedType, elementType, \"SafeArray\")", "binaryAttribute");
                    }
                    else
                    {
                        // type ignored:
            ...
            for (int i = 0; i < paramNames.Length; i++)
            {
                switch (paramNames[i])
                {
                    ...
                    case "SizeParamIndex":
                        ...
                        break;
                    case "SafeArraySubType":
                        throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_InvalidParameterForUnmanagedType, paramNames[i], isFixed ? \"ByValArray\" : \"LPArray\")", "binaryAttribute");
                        // other parameters ignored with no error
                }
            }
