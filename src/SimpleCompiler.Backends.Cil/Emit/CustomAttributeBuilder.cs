...
#pragma warning disable CA2208 // Instantiate argument exceptions correctly, combination of arguments used
            if (namedProperties.Length != propertyValues.Length)
                throw new ArgumentException("TODO: Fill in with result of SR.Arg_ArrayLengthsDiffer", "namedProperties, propertyValues");
            if (namedFields.Length != fieldValues.Length)
                throw new ArgumentException("TODO: Fill in with result of SR.Arg_ArrayLengthsDiffer", "namedFields, fieldValues");
#pragma warning restore CA2208

            if ((con.Attributes & MethodAttributes.Static) == MethodAttributes.Static ||
                (con.Attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Private)
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadConstructor");
            }

            if ((con.CallingConvention & CallingConventions.Standard) != CallingConventions.Standard)
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadConstructorCallConv");
            ...
            paramTypes = Array.ConvertAll(con.GetParameters(), x => x.ParameterType);
            ...
            if (paramTypes.Length != constructorArgs.Length)
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadParameterCountsForConstructor");
            ...
            for (i = 0; i < paramTypes.Length; i++)
            {
                if (!ValidateType(paramTypes[i]))
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadTypeInCustomAttribute");
            }
            ...
            for (i = 0; i < namedProperties.Length; i++)
            {
                ...
                if (!property.CanWrite)
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_NotAWritableProperty");
                ...
                {
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadPropertyForConstructorBuilder");
                }
            ...
            for (i = 0; i < namedFields.Length; i++)
            {
                ...
                {
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadFieldForConstructorBuilder");
                }
        ...
        private static bool ValidateType(Type t)
        {
            ...
            if (t.IsEnum)
            {
                return Type.GetTypeCode(Enum.GetUnderlyingType(t)) is TypeCode.SByte or TypeCode.Byte
        ...
        private static void VerifyTypeAndPassedObjectType(Type type, Type passedType, string paramName)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_ConstantDoesntMatch");
            }
            if (passedType == typeof(IntPtr) || passedType == typeof(UIntPtr))
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_BadParameterTypeForCAB, passedType)", paramName);
            }
        }
        ...
        private static void EmitValue(BinaryWriter writer, Type type, object? value)
        {
            ...
            else if (type == typeof(Type))
            {
                ...
                else
                {
                    string? typeName = TypeNameBuilder.ToString((Type) value, TypeNameBuilder.Format.AssemblyQualifiedName)
                        ?? throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_InvalidTypeForCA, value.GetType())");
            ...
            else if (type == typeof(object))
            {
                ...
                if (ot == typeof(object))
                    throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_BadParameterTypeForCAB, ot)");
            ...
            else
            {
                ...
                throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_BadParameterTypeForCAB, typename)");
            }
        }
    }
}
