...
namespace SimpleCompiler.Backend.Cil.Emit
{
    ...
    internal sealed partial class SymbolType : TypeInfo
    {
        ...
        internal static Type? FormCompoundType(string? format, Type baseType, int curIndex)
        {
            ...
            if (format[curIndex] == '&')
            {
                ...
                if (curIndex != format.Length)
                    ...
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_BadSigFormat");
        ...
        {
            if (!IsArray)
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_HasToBeArrayClass");

            return _rank;
        }

        public override Guid GUID => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)]
        public override object InvokeMember(string name, BindingFlags invokeAttr, Binder? binder, object? target,
            object?[]? args, ParameterModifier[]? modifiers, CultureInfo? culture, string[]? namedParameters) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        ...
        public override Module Module
        {
            get
            {
                ...
                for (baseType = _baseType; baseType is SymbolType type; baseType = type._baseType) ;
        ...
        public override RuntimeTypeHandle TypeHandle => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        ...
        protected override ConstructorInfo GetConstructorImpl(BindingFlags bindingAttr, Binder? binder,
                CallingConventions callConvention, Type[] types, ParameterModifier[]? modifiers) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)]
        public override ConstructorInfo[] GetConstructors(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)]
        public override MethodInfo[] GetMethods(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.NonPublicFields)]
        public override FieldInfo GetField(string name, BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.NonPublicFields)]
        public override FieldInfo[] GetFields(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)]
        [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)]
        public override Type GetInterface(string name, bool ignoreCase) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)]
        public override Type[] GetInterfaces() => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicEvents | DynamicallyAccessedMemberTypes.NonPublicEvents)]
        public override EventInfo GetEvent(string name, BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicEvents)]
        public override EventInfo[] GetEvents() => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.NonPublicProperties)]
        protected override PropertyInfo GetPropertyImpl(string name, BindingFlags bindingAttr, Binder? binder,
                Type? returnType, Type[]? types, ParameterModifier[]? modifiers) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.NonPublicProperties)]
        public override PropertyInfo[] GetProperties(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.NonPublicNestedTypes)]
        public override Type[] GetNestedTypes(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.NonPublicNestedTypes)]
        public override Type GetNestedType(string name, BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(GetAllMembersInternal)]
        public override MemberInfo[] GetMember(string name, MemberTypes type, BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(GetAllMembersInternal)]
        public override MemberInfo[] GetMembers(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        ...
        public override InterfaceMapping GetInterfaceMap([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)] Type interfaceType) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicEvents | DynamicallyAccessedMemberTypes.NonPublicEvents)]
        public override EventInfo[] GetEvents(BindingFlags bindingAttr) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        ...
        public override object[] GetCustomAttributes(bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        public override object[] GetCustomAttributes(Type attributeType, bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");

        public override bool IsDefined(Type attributeType, bool inherit) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_NonReflectedType");
        #endregion
    }
}
