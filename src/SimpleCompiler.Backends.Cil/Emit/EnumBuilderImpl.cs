    ...
    internal sealed class EnumBuilderImpl : EnumBuilder
    {
        ...
        internal EnumBuilderImpl(string name, Type underlyingType, TypeAttributes visibility, ModuleBuilderImpl module)
        {
            if ((visibility & ~TypeAttributes.VisibilityMask) != 0)
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_ShouldOnlySetVisibilityFlags", nameof(name));
        ...
        public override object? InvokeMember(
            ...
            ParameterModifier[]? modifiers, System.Globalization.CultureInfo? culture, string[]? namedParameters) => throw new NotSupportedException();
