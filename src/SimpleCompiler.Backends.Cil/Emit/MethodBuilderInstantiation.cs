...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class MethodBuilderInstantiation : MethodInfo
    {
        ...
        public override MethodInfo MakeGenericMethod(params Type[] arguments) => throw new InvalidOperationException("TODO: Fill in with result of SR.Format(SR.Arg_NotGenericMethodDefinition, this)");
