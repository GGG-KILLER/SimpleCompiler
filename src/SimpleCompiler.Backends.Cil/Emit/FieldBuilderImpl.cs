    ...
    internal sealed class FieldBuilderImpl : FieldBuilder
    {
        ...
        internal static void ValidateDefaultValueType(object? defaultValue, Type destinationType)
        {
            if (defaultValue == null)
            {
                ...
                {
                    throw new ArgumentException("TODO: Fill in with result of SR.Argument_ConstantNull");
                }
            }
            else
            {
...
#pragma warning restore SYSLIB0050
        ...
        public override object? GetValue(object? obj) => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");

        public override void SetValue(object? obj, object? val, BindingFlags invokeAttr, Binder? binder, CultureInfo? culture)
            => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");
        public override RuntimeFieldHandle FieldHandle => throw new NotSupportedException("TODO: Fill in with result of SR.NotSupported_DynamicModule");
