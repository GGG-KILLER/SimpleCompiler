...
namespace SimpleCompiler.Backend.Cil.Emit
{
    public abstract class TypeBuilder : TypeInfo
    {
        ...
        public GenericTypeParameterBuilder[] DefineGenericParameters(params string[] names)
        {
            ...
            if (names.Length == 0)
                throw new ArgumentException("TODO: Fill in with result of SR.Arg_EmptyArray", nameof(names));
            ...
            Type[]? parameterTypes, Type[][]? parameterTypeRequiredCustomModifiers, Type[][]? parameterTypeOptionalCustomModifiers)
        {
            ...
            if (parameterTypes != null)
            {
                if (parameterTypeOptionalCustomModifiers != null && parameterTypeOptionalCustomModifiers.Length != parameterTypes.Length)
                    throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_MismatchedArrays, nameof(parameterTypeOptionalCustomModifiers), nameof(parameterTypes))");

                if (parameterTypeRequiredCustomModifiers != null && parameterTypeRequiredCustomModifiers.Length != parameterTypes.Length)
                    throw new ArgumentException("TODO: Fill in with result of SR.Format(SR.Argument_MismatchedArrays, nameof(parameterTypeRequiredCustomModifiers), nameof(parameterTypes))");
            }
        ...
        {
            string s = Constants.GetRankString(rank);
            return SymbolType.FormCompoundType(s, this, 0)!;
        }

        [RequiresDynamicCode("The native code for this instantiation might not be available at runtime.")]
        [RequiresUnreferencedCode("If some of the generic arguments are annotated (either with DynamicallyAccessedMembersAttribute, or generic constraints), trimming can't validate that the requirements of those annotations are met.")]
        public override Type MakeGenericType(params Type[] typeArguments) => TypeBuilderInstantiation.MakeGenericType(this, typeArguments);
        ...
        public static MethodInfo GetMethod(Type type, MethodInfo method)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_MustBeTypeBuilder", nameof(type));
            }
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_NeedGenericMethodDefinition", nameof(method));
            }

            if (method.DeclaringType == null || !method.DeclaringType.IsGenericTypeDefinition)
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_MethodNeedGenericDeclaringType", nameof(method));
            }

            if (type.GetGenericTypeDefinition() != method.DeclaringType)
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_InvalidMethodDeclaringType", nameof(type));
            }
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_NeedNonGenericType", nameof(type));
            }
        ...
        public static ConstructorInfo GetConstructor(Type type, ConstructorInfo constructor)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_ConstructorNeedGenericDeclaringType", nameof(constructor));
            }

            if (type.GetGenericTypeDefinition() != constructor.DeclaringType)
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_InvalidConstructorDeclaringType", nameof(type));
            }
        ...
        public static FieldInfo GetField(Type type, FieldInfo field)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_FieldNeedGenericDeclaringType", nameof(field));
            }

            if (type.GetGenericTypeDefinition() != field.DeclaringType)
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_InvalidFieldDeclaringType", nameof(type));
            }
