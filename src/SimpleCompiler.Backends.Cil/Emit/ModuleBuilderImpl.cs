...
namespace SimpleCompiler.Backend.Cil.Emit
{
    internal sealed class ModuleBuilderImpl : ModuleBuilder
    {
        ...
        private static int GetTokenForHandle(EntityHandle handle)
        {
            if (handle.IsNil)
            {
                throw new InvalidOperationException("TODO: Fill in with result of SR.InvalidOperation_TokenNotPopulated");
            }
        ...
        protected override void CreateGlobalFunctionsCore()
        {
            ...
            {
                throw new InvalidOperationException("TODO: Fill in with result of SR.InvalidOperation_GlobalsHaveBeenCreated");
            }
            ...
            Type[][]? requiredParameterTypeCustomModifiers, Type[][]? optionalParameterTypeCustomModifiers)
        {
            ...
            {
                throw new ArgumentException("TODO: Fill in with result of SR.Argument_GlobalMembersMustBeStatic");
            }
        ...
        [RequiresUnreferencedCode("Methods might be removed")]
        public override MethodInfo[] GetMethods(BindingFlags bindingFlags) => _globalTypeBuilder.GetMethods(bindingFlags);
